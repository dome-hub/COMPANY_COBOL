******************************************************************
      ...
      ******************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT REPORT-FILE ASSIGN TO "EMPLOYEE_REPORT.TXT"
               ORGANIZATION IS LINE SEQUENTIAL.
           SELECT DEPT-REPORT-FILE ASSIGN TO "DEPT_EMPLOYEE_REPORT.TXT"
               ORGANIZATION IS LINE SEQUENTIAL.
       ...
       FD  DEPT-REPORT-FILE.
       01  DEPT-REPORT-FILE-RECORD     PIC X(150).
      ...
      *>          DISPLAY REAL-CURRENT-TIME.
       ...
       GENERATE-SUMMARY-REPORT.
           ...
           MOVE "CS Corporation" TO DEPT-REPORT-FILE-RECORD
           WRITE DEPT-REPORT-FILE-RECORD
           MOVE COMPANY-NAME1 TO DEPT-REPORT-FILE-RECORD
           WRITE DEPT-REPORT-FILE-RECORD
           ...
           MOVE SPACES TO DEPT-REPORT-FILE-RECORD
           MOVE "Dept"                 TO DEPT-REPORT-FILE-RECORD(1:4)
           MOVE "Employee Amount"TO DEPT-REPORT-FILE-RECORD(28:15)
           MOVE "Total dept salary"    TO DEPT-REPORT-FILE-RECORD(55:17)
           WRITE DEPT-REPORT-FILE-RECORD
           ...
           *> แสดง ทั้งหมด
           ...
           MOVE SPACES TO DEPT-REPORT-FILE-RECORD
           STRING "All Total :                    " DELIMITED BY SIZE
                   DISP-TOTAL-EMP DELIMITED BY SIZE
                   "                     " DELIMITED BY SIZE
                   ALL-DISP-TOTAL-SALARY DELIMITED BY SIZE
           INTO DEPT-REPORT-FILE-RECORD
           WRITE DEPT-REPORT-FILE-RECORD
       ...
       PRINT-DEPT.
           ...
           PERFORM UNTIL WS-EOF-SORT = 'Y'
              ...
              MOVE SPACES TO DEPT-REPORT-FILE-RECORD
              MOVE "All dept: " TO DEPT-REPORT-FILE-RECORD
              MOVE FUNCTION UPPER-CASE(WS-PREV-DEPT)
                   TO DEPT-REPORT-FILE-RECORD(10:30)
              MOVE DISP-TOTAL-EMP
                   TO DEPT-REPORT-FILE-RECORD(32:12)
              MOVE DOME-DISPLAY-TOTAL-SALARY
                   TO DEPT-REPORT-FILE-RECORD(60:25)
              WRITE DEPT-REPORT-FILE-RECORD
